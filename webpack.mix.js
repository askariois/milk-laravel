...
mix.copy('resources/admin/dist/img', 'public/img');
mix.copy('resources/admin/dist/js/plugin', 'public/js/plugin');
mix.copy('resources/admin/dist/js/lang', 'public/js/lang');
mix.copy('resources/admin/dist/js/font', 'public/js/font');
