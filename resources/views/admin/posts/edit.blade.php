        ...
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="content_kg" id="summernote_kg" cols="30" rows="10" class="form-control">
              {{$post->content_kg}}</textarea>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="product_temp_kg" class="form-control" id="exampleInputEmail1" placeholder="" value="{{$post->product_temp_kg}}">
            </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="text" name="product_srok_kg" class="form-control" id="exampleInputEmail1" placeholder="" value="{{$post->product_srok_kg}}">
            </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="text" name="product_massa_kg" class="form-control" id="exampleInputEmail1" placeholder="" value="{{$post->product_massa_kg}}">
            </div>
